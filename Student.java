...
public class Student{
    public static void main(String[] args) {
        Courses student01 = new Courses("Dhruva", "Computer Application", "BCA");
        ...
        Map<String, Integer> kapilCoursesMarksLessThan40 = student01.getCoursesMarksLessThan40();
        ...
        for (Map.Entry<String, Integer> entry : kapilCoursesMarksLessThan40.entrySet()) {
